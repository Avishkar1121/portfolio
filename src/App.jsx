      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="flex flex-col gap-4 text-gray-800">
            <p className="text-lg">
              <span role="img" aria-label="email">📧</span> Email: <a href="mailto:avishkarghosalkar4956@gmail.com" className="text-blue-600 hover:underline">avishkarghosalkar4956@gmail.com</a>
            </p>
            <p className="text-lg">
              <span role="img" aria-label="phone">📞</span> Phone: <a href="tel:+918180033311" className="text-blue-600 hover:underline">+91 81800 33311</a>
            </p>
            <p className="text-lg">
              <span role="img" aria-label="linkedin">💼</span> LinkedIn: <a href="https://www.linkedin.com/in/avishkar-ghosalkar-b02b2926b" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">linkedin.com/in/avishkar-ghosalkar-b02b2926b</a>
            </p>
            <p className="text-lg">
              <span role="img" aria-label="github">🐙</span> GitHub: <a href="https://github.com/Avishkar1121" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">github.com/Avishkar1121</a>
            </p>
          </div>
        </div>
      </section>
